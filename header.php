        ...
        <div class="row">
            ...
            <div class=" col-md-offset-4 col-md-4">
              <?php
                ...
                <div>  
                         <!-- LOGIN -->
                        <a href="login.php" class="admin-logout" style="font-size: 18px;padding:10px;color:white;;background:transperent;border:2px solid #fff;" ><strong>Post/Sell-AD</strong></a>
                         <!-- LOGIN --> 
            </div>
            </div>
            <!-- /LOGO -->
