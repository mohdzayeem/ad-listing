                    ...
                    <div class="post-container">
                      ...
                      ?>
                        <div class="post-content single-post">
                            ...
                            <h3 style="color:#fff;">Price   : ₹<?php echo $row['ad_price']; ?></h3>
                            <h3 style="color:#fff;">Address : <?php echo $row['ad_address']; ?></h3>
                            <h3 style="color:#fff;">Email   : <?php echo $row['aut_email']; ?></a></h4>
