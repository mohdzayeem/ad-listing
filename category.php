        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                  ...
                  ?>
                  <h2 class="page-heading"style="color:#000;" ><?php echo $row1['category_name']; ?> ADs</h2>
                  <?php
                    ...
                    $sql = "SELECT post.post_id, post.title,post.ad_price,post.aut_email, post.description,post.post_date,post.author,
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                              <div class="inner-content clearfix">
                                  ...
                                  <h3><a > Email :  <?php echo $row['aut_email']; ?></a></h3>
